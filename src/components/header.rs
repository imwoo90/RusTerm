    ...
    rsx! {
        header { class: "shrink-0 pt-6 px-5 pb-2 flex flex-col gap-4 z-20",
            ...
            div { class: "flex gap-2",
                ...
                div { class: "relative flex-1 group flex gap-2",
                    ...
                    label {
                        ...
                        span { class: "material-symbols-outlined settings-icon text-[20px] text-gray-500 transition-all duration-300", "settings" }
                    }
                }
            }
        }
