...
pub fn SettingsPanel() -> Element {
    rsx! {
        div {
            class: "mx-5 bg-surface rounded-xl border border-white/10 shadow-2xl transition-all duration-300 max-h-0 opacity-0 overflow-hidden visibility-hidden z-20",
            id: "settings-panel",
